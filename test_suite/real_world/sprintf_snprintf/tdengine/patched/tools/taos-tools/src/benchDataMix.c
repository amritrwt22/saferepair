...
uint32_t dataGenByField(Field* fd, char* pstr, uint32_t len, char* prefix, int64_t *k, char* nullVal) {
    ...
    case TSDB_DATA_TYPE_BOOL:
        (void)snprintf(val, sizeof(val), "%d", tmpBool(fd));
        break;
    // timestamp
    ...
    case TSDB_DATA_TYPE_TINYINT:
        (void)snprintf(val, sizeof(val), "%d", tmpInt8Impl(fd, *k));
        break;
    case TSDB_DATA_TYPE_SMALLINT:
        (void)snprintf(val, sizeof(val), "%d", tmpInt16Impl(fd, *k));
        break;
    case TSDB_DATA_TYPE_INT:
        (void)snprintf(val, sizeof(val), "%d", tmpInt32Impl(fd, 0, 0, *k));
        break;
    ...
    case TSDB_DATA_TYPE_UTINYINT:
        (void)snprintf(val, sizeof(val), "%u", tmpUint8Impl(fd, *k));
        break;
    case TSDB_DATA_TYPE_USMALLINT:
        (void)snprintf(val, sizeof(val), "%u", tmpUint16Impl(fd, *k));
        break;
    case TSDB_DATA_TYPE_UINT:
        (void)snprintf(val, sizeof(val), "%u", tmpUint32Impl(fd, 0, 0, *k));
        break;
    ...
    case TSDB_DATA_TYPE_FLOAT:
        (void)snprintf(val, sizeof(val), "%f", tmpFloatImpl(fd, 0, 0, *k));
        break;
    case TSDB_DATA_TYPE_DOUBLE:
        (void)snprintf(val, sizeof(val), "%f", tmpDoubleImpl(fd, 0, *k));
        break;
